...
class ShulkerBox extends Transparent{
    ...
    public function place(Item $item, Block $block, Block $target, $face, $fx, $fy, $fz, Player $player = null){
        ...
        if(isset($tag->Items) && sizeof($tag->Items->getValue()) > 0) $nbt->Items = $tag->Items;
    ...
    public function onBreak(Item $item, Player $player = null): bool{
        ...
        if($t instanceof TileShulkerBox) {
            ...
            if(isset($t->namedtag->CustomName)) $itemNBT->CustomName = $t->namedtag->CustomName;
            $item->setNamedTag($itemNBT);
            if(isset($t->namedtag->CustomName)) $item->setCustomName($t->namedtag->CustomName);
