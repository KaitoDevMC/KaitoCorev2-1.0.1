...
class Zombie extends Monster {
	...
	public function getDrops(){
		...
		if($cause instanceof EntityDamageByEntityEvent){
			...
			if($damager instanceof Player){
				...
				if($count > 0) $drops[] = ItemItem::get(ItemItem::ROTTEN_FLESH, 0, $count);
			}
		}
	...
	public function onUpdate($currentTick){
		...
		if((!$this->isInsideOfWater()) && ($time < Level::TIME_NIGHT || $time > Level::TIME_SUNRISE) && (!$this->hasHeadBlock())) $this->setOnFire(1);
