		...
		if($this->age > 1200 or $this->isCollided){
			if(!$this->hasTeleportedShooter){
				...
				if($this->getOwningEntity() instanceof Player and $this->y > 0){
					$this->getLevel()->addSound(new EndermanTeleportSound($this->getPosition()), [$this->getOwningEntity()]);
					$this->getOwningEntity()->teleport($this->getPosition());
					$this->getOwningEntity()->attack(4, new EntityDamageByEntityEvent($this, $this->getOwningEntity(), EntityDamageEvent::CAUSE_FALL, 4));
				}
