			...
			if($damager instanceof Player){
				$lootingL = $damager->getItemInHand()->getEnchantmentLevel(Enchantment::TYPE_WEAPON_LOOTING);
					if($damager->getItemInHand()->hasEnchantment(13)){
						$drops = [ItemItem::get(ItemItem::STEAK, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::LEATHER, 0, mt_rand(1, 3 + $lootingL))];
						return $drops;
					}else{
						$drops = [ItemItem::get(ItemItem::RAW_BEEF, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::LEATHER, 0, mt_rand(1, 3 + $lootingL))];
						return $drops;
				}			
			}
		}
