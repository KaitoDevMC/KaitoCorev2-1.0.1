	...
	public function getDrops(){
		...
		if($cause instanceof EntityDamageByEntityEvent){
			...
			if($damager instanceof Player){
				...
				$drops = [ItemItem::get(ItemItem::ARROW, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::BONE, 0, mt_rand(1, 3 + $lootingL))];
				if(mt_rand(1, 200) == 200){
					$drops = [ItemItem::get(ItemItem::ARROW, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::BONE, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::BOW, mt_rand(50, 250), 1)];
				}
				return $drops;	
			}
		}
