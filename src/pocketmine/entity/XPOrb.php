...
class XPOrb extends Entity {
	...
	public function initEntity(){
		parent::initEntity();
		if(isset($this->namedtag->Experience)) $this->experience = $this->namedtag["Experience"];
		else $this->close();
	}
	...
	public function onUpdate($currentTick){
		...
		if($this->age > 150){
			$this->setMotion(new Vector3(50, 50, 50));
			$this->kill();
			$this->close();
			$hasUpdate = true;
		}
		...
		if($target !== null){
			...
			if($this->isInsideOfSolid()) $this->setPosition($target);
		}
