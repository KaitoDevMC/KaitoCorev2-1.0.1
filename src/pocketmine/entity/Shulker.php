...
class Shulker extends Monster {
	...
	public function getDrops(){
		...
		if($cause instanceof EntityDamageByEntityEvent){
			...
			if($damager instanceof Player){
				...
				$drops = [ItemItem::get(ItemItem::SHULKER_SHELL, 0, mt_rand(1, 3 + $lootingL))];
				return $drops;	
			}
		}
		return [];
  ...
  //       }
		...
		// 							$ev->useArmors();
		// 						}
		// 						$this->farest->addEffect(Effect::getEffect(24)->setDuration(160)->setAmplifier(1)->setVisible(true));
		// 						$this->attackTicks = 200;
		// 					}
		// 				}
		// 			}
