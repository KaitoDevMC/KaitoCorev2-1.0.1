			...
			if($damager instanceof Player){
				$lootingL = $damager->getItemInHand()->getEnchantmentLevel(14);
					if($damager->getItemInHand()->hasEnchantment(13)){
						$drops = [ItemItem::get(ItemItem::FEATHER, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::COOKED_CHICKEN, 0, mt_rand(1, 3 + $lootingL))];
						return $drops;
					}else{
						$drops = [ItemItem::get(ItemItem::FEATHER, 0, mt_rand(1, 3 + $lootingL)), ItemItem::get(ItemItem::RAW_CHICKEN, 0, mt_rand(1, 3 + $lootingL))];
						return $drops;
				}			
			}
		}
