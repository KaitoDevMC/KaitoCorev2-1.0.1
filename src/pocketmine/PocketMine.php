...
namespace pocketmine {
	...
	if(!flock(\pocketmine\LOCK_FILE, LOCK_EX | LOCK_NB)){
		...
		echo "[CRITICAL] Este kernel ya se está ejecutando: (" . realpath(\pocketmine\DATA) . ")." . PHP_EOL;
		echo "[CRITICAL] Detenerlo para ejecutar esto!" . PHP_EOL;
		exit(1);
	}
