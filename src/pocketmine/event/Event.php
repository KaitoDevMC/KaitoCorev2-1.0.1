...
abstract class Event {
	...
	public function isCancelled(){
		if(!($this instanceof Cancellable)) throw new \BadMethodCallException(get_class($this) . " is not Cancellable");
	...
	public function getHandlers(){
		if(static::$handlerList === null) static::$handlerList = new HandlerList();
