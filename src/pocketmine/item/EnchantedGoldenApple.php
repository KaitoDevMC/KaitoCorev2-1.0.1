...
class EnchantedGoldenApple extends Food {
	...
	public function getAdditionalEffects(): array {
    	return [
        	Effect::getEffect(Effect::STRENGTH)->setDuration(200)->setAmplifier(2),
        	Effect::getEffect(Effect::REGENERATION)->setDuration(300)->setAmplifier(1),
        	Effect::getEffect(Effect::DAMAGE_RESISTANCE)->setDuration(300)->setAmplifier(0),
    	];
	}
}
