	...
	public function calcWeather($currentTick){
		if($this->canCalculate()){
			...
			if($this->duration <= 0){
				...
				if($this->weatherNow === self::SUNNY) $this->setWeather($this->randomWeatherData[array_rand($this->randomWeatherData)], $duration);
				else $this->setWeather(self::SUNNY, $duration);
			}
