...
class ChunkRequestTask extends AsyncTask {
	...
	public function onCompletion(Server $server){
		...
		if($level instanceof Level){
			...
			}else $server->getLogger()->error("Chunk request for level #" . $this->levelId . ", x=" . $this->chunkX . ", z=" . $this->chunkZ . " doesn't have any result data");
		}else $server->getLogger()->debug("Dropped chunk task due to level not loaded");
	}
