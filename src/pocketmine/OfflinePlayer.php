...
class OfflinePlayer implements IPlayer, Metadatable {
	...
	public function __construct(Server $server, string $name){
		$this->server = $server;
		$this->name = $name;
		if($this->server->hasOfflinePlayerData($this->name)) $this->namedtag = $this->server->getOfflinePlayerData($this->name);
	}
	...
	public function setOp($value){
		...
		if($value) $this->server->addOp(strtolower($this->getName()));
		else $this->server->removeOp(strtolower($this->getName()));
	}
	...
	public function setBanned($value){
		if($value) $this->server->getNameBans()->addBan($this->getName(), null, null, null);
	...
	public function setWhitelisted($value){
		if($value) $this->server->addWhitelist(strtolower($this->getName()));
