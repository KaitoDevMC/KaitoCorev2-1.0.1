...
abstract class Tile extends Position {
	...
	public static function getSaveId() : string{
		if(!isset(self::$shortNames[static::class])) throw new \InvalidStateException("Tile is not registered");
	...
	public final function scheduleUpdate(){
		if($this->closed) throw new \InvalidStateException("Cannot schedule update on garbage tile " . get_class($this));
